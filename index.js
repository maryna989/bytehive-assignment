...
`,d=u.map(s=>`<li class="nav-item"><a href="${s.link}">${s.title}</a></li>`).join(""),f=`
    ...
    `,$=document.querySelector("#js-services");$.insertAdjacentHTML("beforeend",y());const j=document.querySelector("#js-footer");j.innerHTML=a(c);

...
`,f=u.map(e=>`<li class="nav-item"><a class="nav-link" href="${e.link}">${e.title}</a></li>`).join(""),m=document.querySelector(".nav-list"),h=document.querySelector(".header-socials");m.innerHTML=f;h.innerHTML=c(a);const g=[{title:"People",value:"200"},{title:"Our users the world",value:"50"},{title:"Succesfull projects",value:"100"}],v=g.map((e,t)=>{let r=e.value;return t===0?r=`${r}+`:t===1?r=`${r}K`:t===2&&(r=`${r}%`),`<li class="static-item"><h3>${e.title}</h3><p class="item-value">${r}</p></li>`}).join(""),w=document.querySelector(".js-statistics-list");w.innerHTML=v;const L=[{title:"Basic",price:"9",description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit",plan:"Starter",features:["10-hour training","Coffee and lunch","Course files to your email","Individual consulting"]},{title:"Standart",price:"29",description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit",plan:"Medium",features:["10-hour training","Coffee and lunch","Course files to your email","Individual consulting"],popular:!0},{title:"Business",price:"99",description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit",plan:"Large",features:["10-hour training","Coffee and lunch","Course files to your email","Individual consulting"]}];function y(e){return`
        ...
        </li>`}const $=document.querySelector(".js-plans-list");function n(e,t){return t?`${e} ${e}-standart`:e}function k(e,t){return`
                ...
                <div class="plan-features">
                 ...
                 ${t===0?'<p class="plan-features-item">What’s included</p>':""}
                    ...
                    <ul class="list-features">
                        ${e.features.map(y).join("")}
                    </ul>
                </div>
            </li>
        `}$.innerHTML=L.map((e,t)=>k(e,t)).join("");const M=[["Creative Direction","Art Direction","Visual Design","Service Design"],["UX Design","Brand Identity","Concepting","Interaction Design"],["Design Systems","Strategy","Digital Experiences","Consulting"]],S=()=>`
        ${M.map(e=>`
          <div class="services-group">
            ${e.map(t=>`<a href="#" class="service-item">${t}<svg class="icon-arrow" width="13" height="13"><use href='/icons/icons.svg#icon-arrow'></use></svg></a>`).join("")}
            </div>`).join("")}
    `,V=document.querySelector(".js-our-services");V.innerHTML=S();const H=document.querySelector(".js-footer-social");H.innerHTML=c(a);

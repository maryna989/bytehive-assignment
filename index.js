(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))c(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&c(r)}).observe(document,{childList:!0,subtree:!0});function o(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function c(e){if(e.ep)return;e.ep=!0;const s=o(e);fetch(e.href,s)}})();const u=[{title:"About",link:"#"},{title:"Pricing",link:"#"},{title:"Contact",link:"#"}],l=[{platform:"Twitter",link:"#",icon:"#icon-twitter"},{platform:"Facebook",link:"#",icon:"#icon-facebook"},{platform:"Instagram",link:"#",icon:"#icon-instagram"}],a=i=>`
    ...
    `).join("")}
`,d=u.map(i=>`<li class="nav-item"><a href="${i.link}">${i.title}</a></li>`).join(""),f=document.querySelector(".nav-list"),m=document.querySelector(".header-socials");f.innerHTML=d;m.innerHTML=a(l);const p=[{title:"People",value:"200"},{title:"Our users the world",value:"50"},{title:"Succesfull projects",value:"100"}],g=p.map((i,t)=>{let o=i.value;return t===0?o=`${o}+`:t===1?o=`${o}K`:t===2&&(o=`${o}%`),`<li class="static-item"><h3>${i.title}</h3><p class="item-value">${o}</p></li>`}).join(""),v=`<ul class="statistics-list">${g}</ul>`,h=document.querySelector(".js-statistics");document.querySelector("#js-statis");h.insertAdjacentHTML("beforeend",v);const y=[["Creative Direction","Art Direction","Visual Design","Service Design"],["UX Design","Brand Identity","Concepting","Interaction Design"],["Design Systems","Strategy","Digital Experiences","Consulting"]],S=()=>`
    ...
    `,L=document.querySelector("#js-services");L.insertAdjacentHTML("beforeend",S());const n=document.querySelector("#js-footer");n.innerHTML=a(l);const $=n.querySelector(".social-icons-list");$.classList.add("soclist-icons-footer");n.querySelectorAll(".social-item").forEach(i=>i.classList.add("footer-soc-item"));
